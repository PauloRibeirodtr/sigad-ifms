...
@section('page_title', 'Editar PAT')
@section('page_subtitle', 'Atualize os dados do plano de atividades')
    ...
    <div class="mx-auto max-w-3xl">
        ...
        <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-card sm:p-8">
            <div class="mb-7 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <p class="text-sm font-bold text-brand-700">PAT #{{ $plan->id }} · PIT {{ $plan->pit->nome }}</p>
                    <h2 class="mt-1 text-2xl font-extrabold tracking-tight text-slate-950">Editar dados do PAT</h2>
                </div>
